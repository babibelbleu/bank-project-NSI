...
nom_entry1 = Entry(frame, font = ("Helvetica", 20), bg = '#E10BB1', fg = 'black')
nom_entry1.grid(row = 100, column = 0, sticky = W)

# creation de la zone de texte pour le mot de passe
nom_entry2 = Entry(frame, font = ("Helvetica", 20),show='*' ,bg = '#E10BB1', fg = 'black')
nom_entry2.grid(row = 300, column = 0, sticky = W)

#crétion du demandeur de compte(nom utilisateur )
label_title1 = Label(frame, text = "Nom utilisateur", font = ("Helvetica", 20), bg = '#E10BB1')
label_title1.grid(row = 0, column = 0, sticky = W)

# création du demandeur de mot de passe
label_title2 = Label(frame, text = "mot de passe", font = ("Helvetica", 20), bg = '#E10BB1')
label_title2.grid(row = 200, column = 0 , sticky = W)

#création bouton connexion
button = Button(frame, text = "connexion", font = ("Helvetica", 20), bg = '#0B2FE1')
button.grid(row = 400, column = 0 , sticky = N)

##création bouton connexion
button1 = Button(frame, text = "se créer un compte", font = ("Helvetica", 20), bg = '#0B2FE1')
